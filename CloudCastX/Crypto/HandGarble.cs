...
namespace CloudCast.Crypto
{
    ...
    internal class HandGarble
    {
        public void Garble(byte[] buffer0, byte[] buffer1, byte[] buffer2, byte[] buffer3, byte[] buffer4)
        {
            ...
            buffer2[12] += (byte)(((((~(buffer1[4] & 0xff)) ^ (buffer2[(buffer1[12] & 0xff) % 35] & 0xff)) | (buffer1[182] & 0xff)) & 192) | (((~(buffer1[4] & 0xff)) ^ (buffer2[(buffer1[12] & 0xff) % 35] & 0xff)) & (buffer1[182] & 0xff)));
            buffer1[36] += 125;
            buffer1[124] = (byte)Rol8x(((((74 & (buffer1[138] & 0xff)) | ((74 | (buffer1[138] & 0xff)) & (buffer0[15] & 0xff))) & (buffer0[(buffer1[43] & 0xff) % 20] & 0xff)) | (((74 & (buffer1[138] & 0xff)) | ((74 | (buffer1[138] & 0xff)) & (buffer0[15] & 0xff)) | (buffer0[(buffer1[43] & 0xff) % 20] & 0xff)) & 95)), 4);
            ...
            buffer2[2] += (byte)(((((buffer0[(buffer3[20] & 0xff) % 20] & 0xff) << 1) & 159) | ((buffer4[(buffer1[190] & 0xff) % 21] & 0xff) & ~159))
                    & (((((buffer4[(buffer3[64] & 0xff) % 21] & 0xff) & 110) | ((buffer0[(buffer1[25] & 0xff) % 20] & 0xff) & ~110)) & ~150) | ((buffer1[25] & 0xff) & 150)));
            ...
            buffer0[13] = (byte)(((((((buffer0[(buffer3[40] & 0xff) % 20] & 0xff) | (buffer1[10] & 0xff)) & 82) | ((buffer0[(buffer3[40] & 0xff) % 20] & 0xff) & (buffer1[10] & 0xff))) & 209) |
